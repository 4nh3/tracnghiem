...
$monhoc = array();
$sql = "SELECT mamon, tenmon FROM nn";
...
if (isset($_POST['btnSubmit'])) {
    ...
    $OpD = $_POST['OptionD'];
    $ans = $_POST['answer'];
    $sql = "UPDATE `ques_nn` SET `cauhoi`='$ques', `A`='$OpA', `B`='$OpB', `C`='$OpC', `D`='$OpD', `dapan`='$ans', `mamon`='$mmon' WHERE stt = '$eid'";
    $result = mysqli_query($connect, $sql);
    if ($result) {
        echo "<script>";
...
$sql = "SELECT * FROM `ques_nn` WHERE stt = '$eid'";
$result = mysqli_query($connect, $sql);
